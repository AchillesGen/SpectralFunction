...
class Interp1D {
    public:
        ...
        void SetPolyOrder(std::size_t order) { polyOrder = order+1; }
...
class Interp2D {
    public:
        ...
        void SetType(InterpolationType mode) { kMode = mode; }
        void SetPolyOrder(std::size_t orderX, std::size_t orderY) { 
    ...
    private:
        ...
        bool kSplineInit{};
        InterpolationType kMode{InterpolationType::CubicSpline};
        std::size_t polyOrderX{4}, polyOrderY{4};
